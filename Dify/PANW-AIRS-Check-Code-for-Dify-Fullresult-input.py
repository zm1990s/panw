...
def main(input: str) -> dict:
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            dlp = str(response_data.get("prompt_detected", {}).get("dlp", ""))
            injection = str(response_data.get("prompt_detected", {}).get("injection", ""))
            url_cats = str(response_data.get("prompt_detected", {}).get("url_cats", ""))
            toxic_content = str(response_data.get("prompt_detected", {}).get("toxic_content", ""))
